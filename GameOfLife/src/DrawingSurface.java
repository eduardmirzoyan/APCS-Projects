...
public class DrawingSurface extends PApplet {
	...
	public void draw() { 
		...
		text("Enter: Run 1 step\nSpace: Start/Stop\nUp arrow: Increase speed\nDown arrow: Decrease speed\n\nSpeed: " + (60.0/speed) + " per sec\nGeneration:" + board.getGen() + "\n\nNumber of Alive: " + board.getLive() + "\nNumber in Row 10: " + board.getRow(10) + "\nNumber in Colomn 10: " + board.getColumn(10), height+20, 30);
	...
	public void mousePressed() {
		if (mouseButton == LEFT) {
			...
			if (cellCoord != null) {
				//System.out.println(board.neighbors(cellCoord.x, cellCoord.y));
